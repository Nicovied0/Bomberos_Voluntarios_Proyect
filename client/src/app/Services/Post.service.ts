...
export class PostService {
  ...
  obtenerPublicaciones(desde: number = 0, cantidad: number = 10): Observable<Publicacion[]> {
    return this.http.get<Publicacion[]>(`${this.apiUrl}?desde=${desde}&cantidad=${cantidad}`).pipe(
